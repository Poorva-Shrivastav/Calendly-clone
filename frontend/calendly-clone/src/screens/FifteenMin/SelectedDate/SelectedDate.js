      ...
      <div className="outerdiv-selectedDate">
        ...
        <div className="right-container-selectedDate">
          <div>
            ...
            <div className="timezone">{/* Time Zone - Yet to fix */}</div>
          </div>
        </div>
        <div className="rightmost-popup-selectedDate">
          <div>
            ...
            >
              ...
              <div>
                <button
                  className={clicked == "11" ? "newSetTime" : "setTime"}
                  value="11"
                  name="11.00am - 11:15am"
                  data-start="11:00"
                  data-end="11:15"
                  onClick={setTimeSlot}
                >
              ...
              <div>
                <button
                  className={clicked == "13" ? "newSetTime" : "setTime"}
                  value="13"
                  name="13.00 - 13:15"
                  data-start="13:00"
                  data-end="13:15"
              ...
              <div>
                <button
                  className={clicked == "13.15" ? "newSetTime" : "setTime"}
                  value="13.15"
                  name="13.15 - 13:30"
                  data-start="13:15"
                  data-end="13:30"
              ...
              <div>
                <button
                  className={clicked == "13.30" ? "newSetTime" : "setTime"}
                  value="13.30"
                  name="13.30 - 13:45"
                  data-start="13:30"
                  data-end="13:45"
              ...
              <div>
                <button
                  className={clicked == "13.45" ? "newSetTime" : "setTime"}
                  value="13.45"
                  name="13.45 - 14:00"
                  data-start="13:45"
                  data-end="14:00"
              ...
              <div>
                <button
                  className={clicked == "14" ? "newSetTime" : "setTime"}
                  value="14"
                  name="14.00 - 14:15"
                  data-start="14:00"
                  data-end="14:15"
              ...
              <div>
                <button
                  className={clicked == "14.15" ? "newSetTime" : "setTime"}
                  value="14.15"
                  name="14.15 - 14:30"
                  data-start="14:15"
                  data-end="14:30"
              ...
              <div>
                <button
                  className={clicked == "14.30" ? "newSetTime" : "setTime"}
                  value="14.30"
                  name="14.30 - 14:45"
                  data-start="14:30"
                  data-end="14:45"
              ...
              <div>
                <button
                  className={clicked == "14.45" ? "newSetTime" : "setTime"}
                  value="14.45"
                  name="14.45 - 14:00"
                  data-start="14:45"
                  data-end="15:00"
              ...
              <div>
                <button
                  className={clicked == "15.15" ? "newSetTime" : "setTime"}
                  value="15.15"
                  name="15.15 - 15:30"
                  data-start="15:15"
                  data-end="15:30"
              ...
              <div>
                <button
                  className={clicked == "15.30" ? "newSetTime" : "setTime"}
                  value="15.30"
                  name="15.30 - 15:35"
                  data-start="15:30"
                  data-end="15:45"
              ...
              <div>
                <button
                  className={clicked == "15.45" ? "newSetTime" : "setTime"}
                  value="15.45"
                  name="15.45 - 16:00"
                  data-start="15:45"
                  data-end="16:00"
              ...
              <div>
                <button
                  className={clicked == "16" ? "newSetTime" : "setTime"}
                  value="16"
                  name="16.00 - 16:15"
                  data-start="16:00"
                  data-end="16:15"
              ...
              <div>
                <button
                  className={clicked == "16.15" ? "newSetTime" : "setTime"}
                  value="16.15"
                  name="16.15 - 16:30"
                  data-start="16:15"
                  data-end="16:30"
              ...
              <div>
                <button
                  className={clicked == "16.30" ? "newSetTime" : "setTime"}
                  value="16.30"
                  name="16.15 - 16:30"
                  data-start="16:15"
                  data-end="16:30"
              ...
              <div>
                <button
                  className={clicked == "16.45" ? "newSetTime" : "setTime"}
                  value="16.45"
                  name="16.45 - 17:00"
                  data-start="16:45"
                  data-end="17:00"
